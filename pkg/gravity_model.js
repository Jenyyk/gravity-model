 ...
 * @returns {Promise<any>}
 */
export function simulate(input, progress_callback) {
    const ret = wasm.simulate(input, progress_callback);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('gravity_model_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
